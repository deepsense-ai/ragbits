    ...
    async def chat(
        ...
        if context.session_id:
            ...
            if not auth_result.success:
                yield ChatResponse(
                    type=ChatResponseType.TEXT, content=f"Authentication failed: {auth_result.error_message}"
                )
                return
            ...
            yield ChatResponse(type=ChatResponseType.TEXT, content="Authentication required. Please login first.")
            return
