...
To use the planning-enabled variant, pass `gaia_planning_agent`. The script will
...
async def main(agent_path: str | None) -> None:
    ...
    log_file = "gaia_planning_examples.ndjson" if use_planning else "gaia_examples.ndjson"
