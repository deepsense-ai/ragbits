...
If you want to use the planning-enabled variant, pass `hotpot_planning_agent` instead.
The script will conditionally print planning stats when the agent is planning-based and
...
from utils import build_hotpot_retriever, print_planning_stats
...
async def main(agent_path: str | None) -> None:
    ...
    log_file = "hotpot_planning_examples.ndjson" if use_planning else "hotpot_examples.ndjson"
