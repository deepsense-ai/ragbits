...
- Add `ragbits.core.storage` module with shared database connection abstractions (`DatabaseConnection`, `PostgresConnection`, `SQLiteConnection`) and pluggable `KVStore`/`SQLStore` backends for Postgres and SQLite.
