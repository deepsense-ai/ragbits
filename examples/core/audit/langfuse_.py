"""
Ragbits Core Example: Langfuse Audit

This example demonstrates how to collect traces using Ragbits audit module with Langfuse.
We run the LLM generation several times to emit telemetry data, which is automatically captured by Langfuse.

Before running the script, follow these steps:

    1. Open your browser and navigate to https://cloud.langfuse.com (or your self-hosted instance).
...
To run the script, execute the following command:
    ...
    ```bash
    uv run examples/core/audit/langfuse_.py
    ```

To visualize the traces collected by Ragbits, follow these steps:

    1. Navigate to your project in Langfuse.
    2. Go to the Traces section to see all captured traces.
    3. Click on individual traces to see the span hierarchy and details.
"""  # noqa: E501

# /// script
# requires-python = ">=3.10"
# dependencies = [
#     "ragbits-core[langfuse]",
#     "google-auth>=2.35.0",
#     "tqdm",
# ]
# ///
...
# Ragbits observability setup - Langfuse focuses on traces
set_trace_handlers("langfuse")
