...
class AdapterPipeline:
    ...
    def __init__(self, adapters: list[ResponseAdapter[Any, Any]] | None = None) -> None:
        ...
        """
        self._adapters: list[ResponseAdapter[Any, Any]] = adapters or []

    def add(self, adapter: ResponseAdapter[Any, Any]) -> None:
