...
| [Local LLM with Ollama](/examples/core/llms/ollama.py)                                 | [ragbits-core](/packages/ragbits-core)                | Example of how to use LiteLLM to connect to a model hosted locally by Ollama.                                                           |
