...
export interface ChatContext {
  ...
  /**
   * Files attached to the current chat message. Populated by the server from multipart parts on /api/chat; any value supplied by the client in the JSON context is overwritten.
   */
...
export interface AttachmentsConfig {
  /**
   * Maximum size of a single attachment in MB
   */
  max_size_mb: number;
  /**
