...
async def test_litellm_embedder_get_vector_size_with_none_dimensions():
    ...
    with patch.object(embedder, "_get_litellm_module") as mock_get_module:
        mock_litellm = MagicMock()
        mock_litellm.aembedding = mock_embedding = AsyncMock()
        mock_litellm.openai = MagicMock()
        mock_get_module.return_value = mock_litellm
